...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_BLACKPILL_F411CE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_BLACKPILL_F411CE_STM32F411XE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_CODE_PARTITION_ADDRESS_INVALID, 1);
